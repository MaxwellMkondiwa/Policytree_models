...
# Correlation
library(modelsummary)
#datasummary_correlation(LDSestim_Desc)

datasummary_correlation(LDSestim_Desc[,c("L.tonPerHectare","G.q5305_irrigTimes","G.q5305_irrigTimes_cat_One","G.q5305_irrigTimes_cat_Two","G.q5305_irrigTimes_cat_Three","G.q5305_irrigTimes_cat_Fourplus","Sowing_Date_Schedule_T5_16Dec","Sowing_Date_Schedule_T4_15Dec","Sowing_Date_Schedule_T3_30Nov","Sowing_Date_Schedule_T2_20Nov","Sowing_Date_Schedule_T1_10Nov","A.q112_fEdu_new_noSchooling","A.q112_fEdu_new_primary","A.q112_fEdu_new_matriculation","A.q112_fEdu_new_seniorSecondary", "A.q112_fEdu_new_bachelors","A.q112_fEdu_new_Postgrad","Nperha","P2O5perha","Weedmanaged","variety_type_NMWV","Sowing_Date_Early","I.q5505_weedSeverity_num","I.q5509_diseaseSeverity_num","I.q5506_insectSeverity_num","I.q5502_droughtSeverity_num",        "temp","precip","wc2.1_30s_elev","M.q708_marketDistance","C.q306_cropLarestAreaHA","A.q112_fEdu_new_num","Caste_marginalized","Plot_owned","A.q111_fGenderdum","nitrogen_0.5cm","sand_0.5cm","soc_5.15cm","Jan_tmin_18","Feb_tmin_18","Mar_tmin_18","Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18","Apr_tmax_18","O.largestPlotGPS.Longitude","O.largestPlotGPS.Latitude")])
...
# Using specific variables for targeting 
# tr_herb_train_sm <- policy_tree(X_cf_herb[,c("C.q306_cropLarestAreaHA","G.q5305_irrigTimes")], DR.scores_herb, depth = 2) 
# 
# plot(tr_herb_train_sm)
...
LDSestim_sow=subset(LDSestim, select=c("hhid","Sowing_Date_Schedule_rating_num","Jan_tmin_18","Feb_tmin_18","Mar_tmin_18", "Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18", "Apr_tmax_18","Sowing_Date_Early","Sowing_Date_Schedule","L.tonPerHectare","I.q5505_weedSeverity_num","I.q5509_diseaseSeverity_num","I.q5506_insectSeverity_num","I.q5502_droughtSeverity_num",                                       "Nperha","P2O5perha","variety_type_NMWV","G.q5305_irrigTimes","A.q111_fGenderdum","Weedmanaged","temp","precip","wc2.1_30s_elev",
                                                       "M.q708_marketDistance","C.q306_cropLarestAreaHA","A.q112_fEdu_new_num","Caste_marginalized","Plot_owned","nitrogen_0.5cm","sand_0.5cm", "soc_5.15cm","O.largestPlotGPS.Longitude","O.largestPlotGPS.Latitude"))
...
X_cf_sowing=subset(LDSestim_sow, select=c("Jan_tmin_18","Feb_tmin_18","Mar_tmin_18", "Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18", "Apr_tmax_18","I.q5505_weedSeverity_num","I.q5509_diseaseSeverity_num","I.q5506_insectSeverity_num",
                                                  "Nperha","P2O5perha","variety_type_NMWV","G.q5305_irrigTimes","A.q111_fGenderdum","Weedmanaged","temp","precip","wc2.1_30s_elev",
                                                       "M.q708_marketDistance","C.q306_cropLarestAreaHA","A.q112_fEdu_new_num","Caste_marginalized","Plot_owned","nitrogen_0.5cm","sand_0.5cm", "soc_5.15cm"))
...
irrig_test_assignment$targeted_policy_val=irrig_test_assignment$gamma.hat.irrig.4*irrig_test_assignment$depth2_est_eval_irrig_4+irrig_test_assignment$gamma.hat.irrig.3*irrig_test_assignment$depth2_est_eval_irrig_3
...
LDSestim_variety=subset(LDSestim_variety, select=c("hhid","Jan_tmin_18","Feb_tmin_18","Mar_tmin_18", "Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18", "Apr_tmax_18","D.q410_varName","G.q5305_irrigTimes_cat","Sowing_Date_Schedule_rating_num","Sowing_Date_Schedule","L.tonPerHectare","I.q5505_weedSeverity_num","I.q5509_diseaseSeverity_num","I.q5506_insectSeverity_num","I.q5502_droughtSeverity_num",             "Nperha","P2O5perha","variety_type_NMWV","G.q5305_irrigTimes","A.q111_fGenderdum","Weedmanaged","Herbicidename_cat","temp","precip","wc2.1_30s_elev",
                                                       "M.q708_marketDistance","C.q306_cropLarestAreaHA","A.q112_fEdu_new_num","Caste_marginalized","Plot_owned","nitrogen_0.5cm","sand_0.5cm", "soc_5.15cm","O.largestPlotGPS.Longitude","O.largestPlotGPS.Latitude"))
...
variety_test_assignment$targeted_policy_val=variety_test_assignment$gamma.hat.variety.8*variety_test_assignment$depth2_est_eval_variety_8+variety_test_assignment$gamma.hat.variety.1*variety_test_assignment$depth2_est_eval_variety_1
...
```{r}
LDSestim_herb$Herbicidename_cat_unordered <- factor( LDSestim_herb$Herbicidename_cat, ordered = FALSE )

# OLS herb
ols_herb = lm(L.tonPerHectare~Herbicidename_cat_unordered+Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm, data = LDSestim_herb)

summary(ols_herb)

# ols sowing
LDSestim_sow$Sowing_Date_Schedule_unordered <- factor( LDSestim_sow$Sowing_Date_Schedule, ordered = FALSE )


ols_sowing=lm(L.tonPerHectare~Sowing_Date_Schedule_unordered+Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+             Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+A.q111_fGenderdum+Weedmanaged+temp+precip+wc2.1_30s_elev+                           M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm, data=LDSestim_sow)

summary(ols_sowing)

# ols irrigation

LDSestim_irrig$G.q5305_irrigTimes_cat_unordered <- factor( LDSestim_irrig$G.q5305_irrigTimes_cat, ordered = FALSE )

ols_irrig=lm(L.tonPerHectare~G.q5305_irrigTimes_cat_unordered+Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+I.q5502_droughtSeverity_num+Nperha+P2O5perha+variety_type_NMWV+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+Weedmanaged+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm,data=LDSestim_irrig)

summary(ols_irrig)

# ols variety

LDSestim_variety$D.q410_varName_unordered <- factor( LDSestim_variety$D.q410_varName, ordered = FALSE )

ols_variety=lm(L.tonPerHectare~D.q410_varName_unordered+Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+Nperha+P2O5perha+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+Weedmanaged+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm,data=LDSestim_variety)

summary(ols_variety)

library(modelsummary)
list_models = list(ols_herb,ols_sowing,ols_irrig,ols_variety)
ols_results_dt=modelsummary(list_models,output = "data.frame", stars = TRUE )
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('ols_results_dt', 'ols_results_dt.csv')"
        ),
        reactable(
            ols_results_dt,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "ols_results_dt"
        )
    )
)

# Combined estimates
LDSestim_variety$Herbicidename_cat_unordered <- factor( LDSestim_variety$Herbicidename_cat, ordered = FALSE )

LDSestim_variety$Sowing_Date_Schedule_unordered <- factor( LDSestim_variety$Sowing_Date_Schedule, ordered = FALSE )

LDSestim_variety$G.q5305_irrigTimes_cat_unordered <- factor( LDSestim_variety$G.q5305_irrigTimes_cat, ordered = FALSE )

LDSestim_variety$D.q410_varName_unordered <- factor( LDSestim_variety$D.q410_varName, ordered = FALSE )


ols_all=lm(L.tonPerHectare~Herbicidename_cat_unordered+D.q410_varName_unordered+Sowing_Date_Schedule_unordered+G.q5305_irrigTimes_cat_unordered+Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+Nperha+P2O5perha+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm,data=LDSestim_variety)

summary(ols_all)

ols_results_all_dt=modelsummary(ols_all,output = "data.frame", stars = TRUE )
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('ols_results_all_dt', 'ols_results_all_dt.csv')"
        ),
        reactable(
            ols_results_all_dt,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "ols_results_all_dt"
        )
    )
)
...
```{r}
## GRF version of random forest 
LDSestim_variety$Herbicidename_cat_num[LDSestim_variety$Herbicidename_cat=="No weeding"]=1
LDSestim_variety$Herbicidename_cat_num[LDSestim_variety$Herbicidename_cat=="Manual"]=2
LDSestim_variety$Herbicidename_cat_num[LDSestim_variety$Herbicidename_cat=="Manual_herb"]=3
LDSestim_variety$Herbicidename_cat_num[LDSestim_variety$Herbicidename_cat=="2,4-D"]=4
LDSestim_variety$Herbicidename_cat_num[LDSestim_variety$Herbicidename_cat=="SulfosulfuronMetsulfuron"]=5


#D.q410_varName
#"HD2967","Local","PBW343","UP262","LOK1","PBW154","Kedar","SUPER303","PBW502","HD2733","HUW234","RR21"

LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="HD2967"]=1
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="Local"]=2
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="PBW343"]=3
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="UP262"]=4
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="LOK1"]=5
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="PBW154"]=6
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="Kedar"]=7
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="SUPER303"]=8
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="PBW502"]=9
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="HD2733"]=10
LDSestim_variety$D.q410_varName_num[LDSestim_variety$D.q410_varName=="HUW234"]=11

# Fit regression forest yield gains
X_rf=subset(LDSestim_variety, select=c("Jan_tmin_18","Feb_tmin_18","Mar_tmin_18", "Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18", "Apr_tmax_18","I.q5505_weedSeverity_num","I.q5509_diseaseSeverity_num","I.q5506_insectSeverity_num",
                                                  "Nperha","P2O5perha","D.q410_varName_num","G.q5305_irrigTimes","Sowing_Date_Schedule_rating_num","Herbicidename_cat_num","A.q111_fGenderdum","temp","precip","wc2.1_30s_elev",
                                                       "M.q708_marketDistance","C.q306_cropLarestAreaHA","A.q112_fEdu_new_num","Caste_marginalized","Plot_owned","nitrogen_0.5cm","sand_0.5cm", "soc_5.15cm"))

Y.multi.forest.rf <- regression_forest(X_rf, Y_cf_variety,
  equalize.cluster.weights = FALSE,
  seed = 2
)

print(Y.multi.forest.rf)

# Variable importance plot
varimp.multi.rf <- variable_importance(Y.multi.forest.rf)

vars=c("Jan_tmin_18","Feb_tmin_18","Mar_tmin_18", "Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18", "Apr_tmax_18","Weed severity","Disease severity","Insect severity",                     "N","Phosphate","Variety","Irrigations","Sowing window","Weeding","Gender","Annual temp","Annual precip","Elevation","Market distance","Plot size","Education","Caste","Land tenure","Soil nitrogen","Soil sand", "Organic carbon")

## variable importance plot ----------------------------------------------------
varimpvars=as.data.frame(cbind(varimp.multi.rf,vars))
names(varimpvars)[1]="Variableimportance"

varimpvars$Variableimportance=formatC(varimpvars$Variableimportance, digits = 2, format = "f")
varimpvars$Variableimportance=as.numeric(varimpvars$Variableimportance)

varimpplotRF=ggplot(varimpvars,aes(x=reorder(vars,Variableimportance),y=Variableimportance))+
   geom_jitter(color="steelblue")+
   coord_flip()+
   labs(x="RF: model variables",y="Variable importance")
 previous_theme <- theme_set(theme_bw(base_size = 16))
 varimpplotRF

ggsave("figures/RF_vip_no_latlong.png", dpi=300, width = 5.88, height = 5.16)
 

Y.hat.multi.all.rf <- predict(Y.multi.forest.rf, estimate.variance = TRUE)$predictions

summary(Y.hat.multi.all.rf)

summary(lm(Y_cf_variety~Y.hat.multi.all.rf))
...
Y.hat.rf.sowing.t1 = predict(Y.multi.forest.rf, newdata=X_rf_sowing.t1, estimate.variance=TRUE)
Y.hat.rf.sowing.t2 = predict(Y.multi.forest.rf, newdata=X_rf_sowing.t2, estimate.variance=TRUE)
Y.hat.rf.sowing.t3 = predict(Y.multi.forest.rf, newdata=X_rf_sowing.t3, estimate.variance=TRUE)
Y.hat.rf.sowing.t4 = predict(Y.multi.forest.rf, newdata=X_rf_sowing.t4, estimate.variance=TRUE)
Y.hat.rf.sowing.t5 = predict(Y.multi.forest.rf, newdata=X_rf_sowing.t5, estimate.variance=TRUE)
...
# Rename some of the columns for convenience
summ_stats_rf <- summ_stats_rf[c("Mean","SE Mean","LCL Mean","UCL Mean","Stdev", "Minimum", "1. Quartile", "Median",  "3. Quartile", "Maximum")] %>% 
  rename("Lower quartile" = '1. Quartile', "Upper quartile"= "3. Quartile")
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('summ_stats_rf', 'summ_stats_rf.csv')"
        ),
        reactable(
            summ_stats_rf,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "summ_stats_rf"
        )
    )
)
...
# Ranger specification
# LDSestim_variety$D.q410_varName_num=as.numeric(LDSestim_variety$D.q410_varName_num)
# LDSestim_ranger=LDSestim_variety[,names(LDSestim_variety)%in%c("Jan_tmin_18","Feb_tmin_18","Mar_tmin_18", "Apr_tmin_18","Jan_tmax_18","Feb_tmax_18","Mar_tmax_18", "Apr_tmax_18","I.q5505_weedSeverity_num","I.q5509_diseaseSeverity_num","I.q5506_insectSeverity_num","Nperha","P2O5perha","variety_type_NMWV","G.q5305_irrigTimes","Sowing_Date_Schedule_rating_num","Herbicidename_cat_num","A.q111_fGenderdum","temp","precip","wc2.1_30s_elev",
#                                                        "M.q708_marketDistance","C.q306_cropLarestAreaHA","A.q112_fEdu_new_num","Caste_marginalized","Plot_owned","nitrogen_0.5cm","sand_0.5cm", "soc_5.15cm","L.tonPerHectare")]
# 
# library(ranger)
# ranger_fit <- ranger(data = LDSestim_ranger,L.tonPerHectare ~ .,importance ="impurity")
#                             
# library(vip)
# library(randomForestExplainer)
# library(survminer)
# 
# vip::vip(ranger_fit, n=20)+
#   theme_classic2()
# 
# library(rpart)
# library(rpart.plot)
# 
# fit.tree = rpart(L.tonPerHectare~ ., data=LDSestim_ranger,  method="anova", cp=0.008)
# 
...
# X_rf_sowing.t1=LDSestim_ranger
# X_rf_sowing.t1$Sowing_Date_Schedule_rating_num=5
# 
# X_rf_sowing.t2=LDSestim_ranger
# X_rf_sowing.t2$Sowing_Date_Schedule_rating_num=4
# 
# X_rf_sowing.t3=LDSestim_ranger
# X_rf_sowing.t3$Sowing_Date_Schedule_rating_num=3
# 
# X_rf_sowing.t4=LDSestim_ranger
# X_rf_sowing.t4$Sowing_Date_Schedule_rating_num=2
# 
# X_rf_sowing.t5=LDSestim_ranger
# X_rf_sowing.t5$Sowing_Date_Schedule_rating_num=1
# 
# # Calculate yield differences against sowing date option 1 (after 16th Dec)
# Y.hat.rf.sowing.t1 = predict(ranger_fit_sowing, data=X_rf_sowing.t1, estimate.variance=TRUE)
# Y.hat.rf.sowing.t2 = predict(ranger_fit_sowing, data=X_rf_sowing.t2, estimate.variance=TRUE)
# Y.hat.rf.sowing.t3 = predict(ranger_fit_sowing, data=X_rf_sowing.t3, estimate.variance=TRUE)
# Y.hat.rf.sowing.t4 = predict(ranger_fit_sowing, data=X_rf_sowing.t4, estimate.variance=TRUE)
# Y.hat.rf.sowing.t5 = predict(ranger_fit_sowing, data=X_rf_sowing.t5, estimate.variance=TRUE)
# 
# 
# Y.hat.rf.sowing.t1_t5 = Y.hat.rf.sowing.t1$predictions-Y.hat.rf.sowing.t5$predictions
# Y.hat.rf.sowing.t2_t5 = Y.hat.rf.sowing.t2$predictions-Y.hat.rf.sowing.t5$predictions
...
# 
# # Rename some of the columns for convenience
# summ_stats_rf_ranger <- summ_stats_rf[c("Mean","SE Mean","LCL Mean","UCL Mean","Stdev", "Minimum", "1. Quartile", "Median",  "3. Quartile", "Maximum")] %>% 
#   rename("Lower quartile" = '1. Quartile', "Upper quartile"= "3. Quartile")
# 
# summ_stats_rf_ranger
# 
# library(reactable)
# library(htmltools)
# library(fontawesome)
...
#         tags$button(
#             tagList(fontawesome::fa("download"), "Download as CSV"),
#             onclick = "Reactable.downloadDataCSV('summ_stats_rf_ranger', 'summ_stats_rf_ranger.csv')"
#         ),
#         reactable(
#             summ_stats_rf_ranger,
#             searchable = TRUE,
#             defaultPageSize = 38,
#             elementId = "summ_stats_rf_ranger"
#         )
#     )
# )
# 
...
```{r}
# Herbicides
X_rf_herb.no_weeding=X_rf
X_rf_herb.no_weeding$Herbicidename_cat_num=1

X_rf_herb.manual=X_rf
X_rf_herb.manual$Herbicidename_cat_num=2

X_rf_herb.manual_herb=X_rf
X_rf_herb.manual_herb$Herbicidename_cat_num=3

X_rf_herb.24D=X_rf
X_rf_herb.24D$Herbicidename_cat_num=4

X_rf_herb.SM=X_rf
X_rf_herb.SM$Herbicidename_cat_num=5

# Calculate yield differences against herb date option 1 (after 16th Dec)
Y.hat.rf.herb.no_weeding = predict(Y.multi.forest.rf, newdata=X_rf_herb.no_weeding, estimate.variance=TRUE)
Y.hat.rf.herb.manual= predict(Y.multi.forest.rf, newdata=X_rf_herb.manual, estimate.variance=TRUE)
Y.hat.rf.herb.manual_herb = predict(Y.multi.forest.rf, newdata=X_rf_herb.manual_herb, estimate.variance=TRUE)
Y.hat.rf.herb.24D = predict(Y.multi.forest.rf, newdata=X_rf_herb.24D, estimate.variance=TRUE)
Y.hat.rf.herb.SM = predict(Y.multi.forest.rf, newdata=X_rf_herb.SM, estimate.variance=TRUE)


Y.hat.rf.herb.manual_no_weeding = Y.hat.rf.herb.manual$predictions-Y.hat.rf.herb.no_weeding$predictions
Y.hat.rf.herb.manual_herb_no_weeding = Y.hat.rf.herb.manual_herb$predictions-Y.hat.rf.herb.no_weeding$predictions

Y.hat.rf.herb.24D_no_weeding = Y.hat.rf.herb.24D$predictions-Y.hat.rf.herb.no_weeding$predictions

Y.hat.rf.herb.SM_no_weeding = Y.hat.rf.herb.SM$predictions-Y.hat.rf.herb.no_weeding$predictions

library(fBasics)
rf_pred_contrasts=as.data.frame(cbind(Y.hat.rf.herb.manual_no_weeding,Y.hat.rf.herb.manual_herb_no_weeding,Y.hat.rf.herb.24D_no_weeding,Y.hat.rf.herb.SM_no_weeding))
...
# Ranger specification
# X_rf_herb.no_weeding=LDSestim_ranger
# X_rf_herb.no_weeding$Herbicidename_cat_num=1
# 
# X_rf_herb.manual=LDSestim_ranger
# X_rf_herb.manual$Herbicidename_cat_num=2
# 
# X_rf_herb.manual_herb=LDSestim_ranger
# X_rf_herb.manual_herb$Herbicidename_cat_num=3
# 
# X_rf_herb.24D=LDSestim_ranger
# X_rf_herb.24D$Herbicidename_cat_num=4
# 
# X_rf_herb.SM=LDSestim_ranger
# X_rf_herb.SM$Herbicidename_cat_num=5
# 
# Y.hat.rf.herb.no_weeding = predict(ranger_fit,data=X_rf_herb.no_weeding, estimate.variance=TRUE)
# Y.hat.rf.herb.manual= predict(ranger_fit,data=X_rf_herb.manual, estimate.variance=TRUE)
# Y.hat.rf.herb.manual_herb = predict(ranger_fit,data=X_rf_herb.manual_herb, estimate.variance=TRUE)
# Y.hat.rf.herb.24D = predict(ranger_fit, data=X_rf_herb.24D, estimate.variance=TRUE)
# Y.hat.rf.herb.SM = predict(ranger_fit, data=X_rf_herb.SM, estimate.variance=TRUE)
# 
# 
# Y.hat.rf.herb.manual_no_weeding = Y.hat.rf.herb.manual$predictions-Y.hat.rf.herb.no_weeding$predictions
# Y.hat.rf.herb.manual_herb_no_weeding = Y.hat.rf.herb.manual_herb$predictions-Y.hat.rf.herb.no_weeding$predictions
...
```{r}
X_rf_irrig.one=X_rf
X_rf_irrig.one$G.q5305_irrigTimes=1

X_rf_irrig.two=X_rf
X_rf_irrig.two$G.q5305_irrigTimes=2

X_rf_irrig.three=X_rf
X_rf_irrig.three$G.q5305_irrigTimes=3

X_rf_irrig.four=X_rf
X_rf_irrig.four$G.q5305_irrigTimes=4

# Calculate yield differences against irrig date option 1 (after 16th Dec)
Y.hat.rf.irrig.one = predict(Y.multi.forest.rf, newdata=X_rf_irrig.one, estimate.variance=TRUE)
Y.hat.rf.irrig.two = predict(Y.multi.forest.rf, newdata=X_rf_irrig.two, estimate.variance=TRUE)
Y.hat.rf.irrig.three = predict(Y.multi.forest.rf, newdata=X_rf_irrig.three, estimate.variance=TRUE)
Y.hat.rf.irrig.four = predict(Y.multi.forest.rf, newdata=X_rf_irrig.four, estimate.variance=TRUE)

Y.hat.rf.irrig.four_one = Y.hat.rf.irrig.four$predictions-Y.hat.rf.irrig.one$predictions
Y.hat.rf.irrig.three_one = Y.hat.rf.irrig.three$predictions-Y.hat.rf.irrig.one$predictions
Y.hat.rf.irrig.two_one = Y.hat.rf.irrig.two$predictions-Y.hat.rf.irrig.one$predictions


library(fBasics)
rf_pred_contrasts=as.data.frame(cbind(Y.hat.rf.irrig.four_one,Y.hat.rf.irrig.three_one,Y.hat.rf.irrig.two_one))
...
# X_rf_variety.HD2967=X_rf
# X_rf_variety.HD2967$D.q410_varName_num=1
# 
# X_rf_variety.Local=X_rf
# X_rf_variety.Local$D.q410_varName_num=2
# 
# X_rf_variety.PBW343=X_rf
# X_rf_variety.PBW343$D.q410_varName_num=3
# 
# X_rf_variety.UP262=X_rf
# X_rf_variety.UP262$D.q410_varName_num=4
# 
# X_rf_variety.LOK1=X_rf
# X_rf_variety.LOK1$D.q410_varName_num=5
# 
# X_rf_variety.PBW154=X_rf
# X_rf_variety.PBW154$D.q410_varName_num=6
# 
# X_rf_variety.Kedar=X_rf
# X_rf_variety.Kedar$D.q410_varName_num=7
# 
# X_rf_variety.SUPER303=X_rf
# X_rf_variety.SUPER303$D.q410_varName_num=8
# 
# X_rf_variety.PBW502=X_rf
# X_rf_variety.PBW502$D.q410_varName_num=9
# 
# X_rf_variety.HD2733=X_rf
# X_rf_variety.HD2733$D.q410_varName_num=10
# 
# X_rf_variety.HUW234=X_rf
# X_rf_variety.HUW234$D.q410_varName_num=11
# 
# # Calculate yield differences against variety date option 1 (after 16th Dec)
# Y.hat.rf.variety.HD2967 = predict(Y.multi.forest.rf, newdata=X_rf_variety.HD2967, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.Local = predict(Y.multi.forest.rf, newdata=X_rf_variety.Local, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.PBW343 = predict(Y.multi.forest.rf, newdata=X_rf_variety.PBW343, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.UP262 = predict(Y.multi.forest.rf, newdata=X_rf_variety.UP262, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.LOK1 = predict(Y.multi.forest.rf, newdata=X_rf_variety.LOK1, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.PBW154 = predict(Y.multi.forest.rf, newdata=X_rf_variety.PBW154, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.Kedar = predict(Y.multi.forest.rf, newdata=X_rf_variety.Kedar, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.SUPER303 = predict(Y.multi.forest.rf, newdata=X_rf_variety.SUPER303, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.PBW502 = predict(Y.multi.forest.rf, newdata=X_rf_variety.PBW502, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.HD2733 = predict(Y.multi.forest.rf, newdata=X_rf_variety.HD2733, estimate.variance=TRUE)
# 
# Y.hat.rf.variety.HUW234 = predict(Y.multi.forest.rf, newdata=X_rf_variety.HUW234, estimate.variance=TRUE)
# 
# #Differences
# 
# Y.hat.rf.variety.Local_HD2967 = Y.hat.rf.variety.Local$predictions-Y.hat.rf.variety.HD2967$predictions
# 
# Y.hat.rf.variety.PBW343_HD2967 = Y.hat.rf.variety.PBW343$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.UP262_HD2967 = Y.hat.rf.variety.UP262$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.LOK1_HD2967 = Y.hat.rf.variety.LOK1$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.PBW154_HD2967 = Y.hat.rf.variety.PBW154$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.Kedar_HD2967 = Y.hat.rf.variety.Kedar$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.SUPER303_HD2967 = Y.hat.rf.variety.SUPER303$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.PBW502_HD2967 = Y.hat.rf.variety.PBW502$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.HD2733_HD2967 = Y.hat.rf.variety.HD2733$predictions-Y.hat.rf.variety.HD2967$predictions
# Y.hat.rf.variety.HUW234_HD2967 = Y.hat.rf.variety.HUW234$predictions-Y.hat.rf.variety.HD2967$predictions
# 
# 
# 
# library(fBasics)
# rf_pred_contrasts=as.data.frame(cbind(Y.hat.rf.variety.Local_HD2967,Y.hat.rf.variety.PBW343_HD2967,Y.hat.rf.variety.UP262_HD2967,Y.hat.rf.variety.LOK1_HD2967,Y.hat.rf.variety.PBW154_HD2967,Y.hat.rf.variety.Kedar_HD2967,Y.hat.rf.variety.SUPER303_HD2967,Y.hat.rf.variety.PBW502_HD2967,Y.hat.rf.variety.HD2733_HD2967,Y.hat.rf.variety.HUW234_HD2967))
# 
# summ_stats_rf <- fBasics::basicStats(rf_pred_contrasts)
# 
# summ_stats_rf <- as.data.frame(t(summ_stats_rf))
...
# GRF Mapping and cross targeting
...
# GRF Distributional comparisons
...
# GRF Variation of CATEs by background variables

## Weeding

```{r}
library(gtools)
tau.multi_herb.forest_X$SM_tau_quartiles <- quantcut(tau.multi_herb.forest_X$predictions.SulfosulfuronMetsulfuron...No.weeding.Y.1)
table(tau.multi_herb.forest_X$SM_tau_quartiles)
...
summary_table_by_vars_SM <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(SM_tau_quartiles), data = tau.multi_herb.forest_X, output = "data.frame")

summary_table_by_vars_SM_t <- t(summary_table_by_vars_SM)
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('summary_table_by_vars_SM', 'summary_table_by_vars_SM.csv')"
        ),
        reactable(
            summary_table_by_vars_SM,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "summary_table_by_vars_SM"
        )
    )
)
...
library(dplyr)
tau.multi_herb.forest_X_std <- tau.multi_herb.forest_X %>%
  select(-hhid) %>%
  mutate_if(is.numeric, scale) %>%
  cbind(hhid = tau.multi_herb.forest_X$hhid)


summary_table_by_vars_SM_std <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(SM_tau_quartiles), data = tau.multi_herb.forest_X_std, output = "data.frame")

summary_table_by_vars_SM_std_t <- t(summary_table_by_vars_SM_std)


write.csv(summary_table_by_vars_SM_std,"tables/summary_table_by_vars_SM_std.csv")
...
# 2,4,-D
tau.multi_herb.forest_X$herb24D_tau_quartiles <- quantcut(tau.multi_herb.forest_X$predictions.2.4.D...No.weeding.Y.1)
table(tau.multi_herb.forest_X$herb24D_tau_quartiles)
...
summary_table_by_vars_24D <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(herb24D_tau_quartiles), data = tau.multi_herb.forest_X, output = "data.frame")

summary_table_by_vars_24D_t <- t(summary_table_by_vars_24D)
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('summary_table_by_vars_24D', 'summary_table_by_vars_24D.csv')"
        ),
        reactable(
            summary_table_by_vars_24D,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "summary_table_by_vars_24D"
        )
    )
)
...
```{r}
library(gtools)
tau.multi_sowing.forest_X$Nov1_10_tau_quartiles <- quantcut(tau.multi_sowing.forest_X$predictions.T1_10Nov...T5_16Dec.Y.1)
table(tau.multi_sowing.forest_X$Nov1_10_tau_quartiles)
...
summary_table_by_vars_Nov1_10 <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(Nov1_10_tau_quartiles), data = tau.multi_sowing.forest_X, output = "data.frame")

summary_table_by_vars_Nov1_10_t <- t(summary_table_by_vars_Nov1_10)
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('summary_table_by_vars_Nov1_10', 'summary_table_by_vars_Nov1_10.csv')"
        ),
        reactable(
            summary_table_by_vars_Nov1_10,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "summary_table_by_vars_Nov1_10"
        )
    )
)
...
# Scaling all continuous variables
library(dplyr)
tau.multi_sowing.forest_X_std <- tau.multi_sowing.forest_X %>%
  select(-hhid) %>%
  mutate_if(is.numeric, scale) %>%
  cbind(hhid = tau.multi_sowing.forest_X$hhid)

summary_table_by_vars_Nov1_10_std <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+G.q5305_irrigTimes+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(Nov1_10_tau_quartiles), data = tau.multi_sowing.forest_X_std, output = "data.frame")

summary_table_by_vars_Nov1_10_std_t <- t(summary_table_by_vars_Nov1_10_std)

write.csv(summary_table_by_vars_Nov1_10_std,"tables/summary_table_by_vars_Nov1_10_std.csv")
...
library(gtools)
tau.multi_irrig.forest_X$Four_tau_quartiles <- quantcut(tau.multi_irrig.forest_X$predictions.Fourplus...One.Y.1)
table(tau.multi_irrig.forest_X$Four_tau_quartiles)
...
summary_table_by_vars_four <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(Four_tau_quartiles), data = tau.multi_irrig.forest_X, output = "data.frame")

summary_table_by_vars_four_t <- t(summary_table_by_vars_four)
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('summary_table_by_vars_four', 'summary_table_by_vars_four.csv')"
        ),
        reactable(
            summary_table_by_vars_four,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "summary_table_by_vars_four"
        )
    )
)
...
# standardized values
library(dplyr)
tau.multi_irrig.forest_X_std <- tau.multi_irrig.forest_X %>%
  select(-hhid) %>%
  mutate_if(is.numeric, scale) %>%
  cbind(hhid = tau.multi_irrig.forest_X$hhid)

summary_table_by_vars_four_std <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+variety_type_NMWV+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(Four_tau_quartiles), data = tau.multi_irrig.forest_X_std, output = "data.frame")

write.csv(summary_table_by_vars_four_std,"tables/summary_table_by_vars_four_std.csv")
...
```{r}
library(gtools)
tau.multi_variety.forest_X$super303_tau_quartiles <- quantcut(tau.multi_variety.forest_X$predictions.SUPER303...HD2967.Y.1)
table(tau.multi_variety.forest_X$super303_tau_quartiles)
...
summary_table_by_vars_super303 <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(super303_tau_quartiles), data = tau.multi_variety.forest_X, output = "data.frame")

summary_table_by_vars_super303_t <- t(summary_table_by_vars_super303)
...
htmltools::browsable(
    tagList(
        tags$button(
            tagList(fontawesome::fa("download"), "Download as CSV"),
            onclick = "Reactable.downloadDataCSV('summary_table_by_vars_super303', 'summary_table_by_vars_super303.csv')"
        ),
        reactable(
            summary_table_by_vars_super303,
            searchable = TRUE,
            defaultPageSize = 38,
            elementId = "summary_table_by_vars_super303"
        )
    )
)
...
# standardized values
library(dplyr)
tau.multi_variety.forest_X_std <- tau.multi_variety.forest_X %>%
  select(-hhid) %>%
  mutate_if(is.numeric, scale) %>%
  cbind(hhid = tau.multi_variety.forest_X$hhid)

summary_table_by_vars_super303_std <- datasummary(Heading("N obs") * N + Heading("%") * Percent()+(Jan_tmin_18+Feb_tmin_18+Mar_tmin_18+Apr_tmin_18+Jan_tmax_18+Feb_tmax_18+Mar_tmax_18+Apr_tmax_18+I.q5505_weedSeverity_num+I.q5509_diseaseSeverity_num+I.q5506_insectSeverity_num+       Nperha+P2O5perha+G.q5305_irrigTimes+Sowing_Date_Schedule_rating_num+A.q111_fGenderdum+temp+precip+wc2.1_30s_elev+M.q708_marketDistance+C.q306_cropLarestAreaHA+A.q112_fEdu_new_num+Caste_marginalized+Plot_owned+nitrogen_0.5cm+sand_0.5cm+soc_5.15cm)*(mean_na + sd_na) ~ Factor(super303_tau_quartiles), data = tau.multi_variety.forest_X_std, output = "data.frame")

summary_table_by_vars_super303_std_t <- t(summary_table_by_vars_super303_std)

write.csv(summary_table_by_vars_super303_std,"tables/summary_table_by_vars_super303_std.csv")
...
#GRF Bivariate Mapping at District Level
...
```{r}
lon <- tau.multi_herb.forest_X$O.largestPlotGPS.Longitude
lon <- as.data.frame(lon)
lat <- tau.multi_herb.forest_X$O.largestPlotGPS.Latitude
lat <- as.data.frame(lat)


tau.multi_herb.forest_X<- cbind(lon, lat, tau.multi_herb.forest_X)

library(sp)
tau.multi_herb.forest_X_sp_kr <-
    SpatialPointsDataFrame(cbind(tau.multi_herb.forest_X$lon, tau.multi_herb.forest_X$lat), data = tau.multi_herb.forest_X, proj4string = CRS("+proj=longlat +datum=WGS84"))

library(bamlss)
set.seed(111)
f <- predictions.SulfosulfuronMetsulfuron...No.weeding.Y.1 ~  s(lon, lat)

## estimate model.
b <- bamlss(f, data = tau.multi_herb.forest_X_sp_kr)
...
herb_hat <- predict(b, newdata = pred_sp)

herb_hat <- as.data.frame(herb_hat)

pred_herb_hat <- cbind(pred, herb_hat)

pred_herb_hat$sigma <- NULL
library(terra)

myras <- rast(pred_herb_hat, type = "xyz")
plot(myras)
...
plot(myras2, main = "Yield gains to S&M herbicide")

library(rasterVis)

levelplot(myras2, layers = 1, margin = list(FUN = 'median'), contour=TRUE)

## 
library(tmap)
myras2_herb_yield_gain=tm_shape(myras2) +
  tm_raster(title = "S&M herbicide yield gain(t/ha)",style = "cont", palette = "viridis")+
  tm_legend(position = c("right", "top"),legend.title.size=1.2,legend.text.size=1.2)
myras2_herb_yield_gain

tmap_save(myras2_herb_yield_gain,"figures/myras2_herb_yield_gain.png", dpi=300,width=4.88,height = 4.16)



# Partial profit gain
### Krige output prices across space
...
```{r}
lon <- tau.multi_sowing.forest_X$O.largestPlotGPS.Longitude
lon <- as.data.frame(lon)
lat <- tau.multi_sowing.forest_X$O.largestPlotGPS.Latitude
lat <- as.data.frame(lat)


tau.multi_sowing.forest_X<- cbind(lon, lat, tau.multi_sowing.forest_X)

library(sp)
tau.multi_sowing.forest_X_sp_kr <-
    SpatialPointsDataFrame(cbind(tau.multi_sowing.forest_X$lon, tau.multi_sowing.forest_X$lat), data = tau.multi_sowing.forest_X, proj4string = CRS("+proj=longlat +datum=WGS84"))

library(bamlss)
set.seed(111)
f_sowing <- predictions.T1_10Nov...T5_16Dec.Y.1 ~  s(lon, lat)

## estimate model.
b_sowing <- bamlss(f_sowing, data = tau.multi_sowing.forest_X_sp_kr)
...
sowing_hat <- predict(b_sowing, newdata = pred_sp)

sowing_hat <- as.data.frame(sowing_hat)

pred_sowing_hat <- cbind(pred, sowing_hat)

pred_sowing_hat$sigma <- NULL
library(terra)

myras_sowing <- rast(pred_sowing_hat, type = "xyz")
plot(myras_sowing)

library(raster)
myras2_sowing <- raster(myras_sowing)

library(sf)
India_aoi_sf_dis_sp <- as_Spatial(India_aoi_sf_dis)

myras2_sowing <- mask(myras2_sowing, India_aoi_sf_dis_sp)

plot(myras2_sowing, main = "Yield gains early sowing (1-10 Nov")

library(rasterVis)

levelplot(myras2_sowing, layers = 1, margin = list(FUN = 'median'), contour=TRUE)

library(tmap)
myras2_sowing_yield_gain=tm_shape(myras2_sowing) +
  tm_raster(title = "Early sowing yield gain(t/ha)",style = "cont", palette = "viridis")+
  tm_legend(position = c("right", "top"),legend.title.size=1.2,legend.text.size=1.2)
myras2_sowing_yield_gain

tmap_save(myras2_sowing_yield_gain,"figures/myras2_sowing_yield_gain.png", dpi=300,width=4.88,height = 4.16)
...
```{r}
lon <- tau.multi_irrig.forest_X$O.largestPlotGPS.Longitude
lon <- as.data.frame(lon)
lat <- tau.multi_irrig.forest_X$O.largestPlotGPS.Latitude
lat <- as.data.frame(lat)


tau.multi_irrig.forest_X<- cbind(lon, lat, tau.multi_irrig.forest_X)

library(sp)
tau.multi_irrig.forest_X_sp_kr <-
    SpatialPointsDataFrame(cbind(tau.multi_irrig.forest_X$lon, tau.multi_irrig.forest_X$lat), data = tau.multi_irrig.forest_X, proj4string = CRS("+proj=longlat +datum=WGS84"))

library(bamlss)
set.seed(111)

f_irrig <- predictions.Fourplus...One.Y.1 ~  s(lon, lat)

## estimate model.
b_irrig <- bamlss(f_irrig, data = tau.multi_irrig.forest_X_sp_kr)
...
irrig_hat <- predict(b_irrig, newdata = pred_sp)

irrig_hat <- as.data.frame(irrig_hat)

pred_irrig_hat <- cbind(pred, irrig_hat)

pred_irrig_hat$sigma <- NULL
library(terra)

myras_irrig <- rast(pred_irrig_hat, type = "xyz")
plot(myras_irrig)

library(raster)
myras2_irrig <- raster(myras_irrig)

library(sf)
India_aoi_sf_dis_sp <- as_Spatial(India_aoi_sf_dis)

myras2_irrig <- mask(myras2_irrig, India_aoi_sf_dis_sp)

plot(myras2_irrig, main = "Yield gains early irrig (1-10 Nov")

library(rasterVis)

levelplot(myras2_irrig, layers = 1, margin = list(FUN = 'median'), contour=TRUE)

library(tmap)
myras2_irrig_yield_gain=tm_shape(myras2_irrig) +
  tm_raster(title = "Four irrigation yield gain(t/ha)",style = "cont", palette = "viridis")+
  tm_legend(position = c("right", "top"),legend.title.size=1.2,legend.text.size=1.2)
myras2_irrig_yield_gain

tmap_save(myras2_irrig_yield_gain,"figures/myras2_irrig_yield_gain.png", dpi=300,width=4.88,height = 4.16)
```

## Variety

```{r}
lon <- tau.multi_variety.forest_X$O.largestPlotGPS.Longitude
lon <- as.data.frame(lon)
lat <- tau.multi_variety.forest_X$O.largestPlotGPS.Latitude
lat <- as.data.frame(lat)


tau.multi_variety.forest_X<- cbind(lon, lat, tau.multi_variety.forest_X)

library(sp)
tau.multi_variety.forest_X_sp_kr <-
    SpatialPointsDataFrame(cbind(tau.multi_variety.forest_X$lon, tau.multi_variety.forest_X$lat), data = tau.multi_variety.forest_X, proj4string = CRS("+proj=longlat +datum=WGS84"))

library(bamlss)
set.seed(111)

f_variety <- predictions.SUPER303...HD2967.Y.1 ~  s(lon, lat)

## estimate model.
b_variety <- bamlss(f_variety, data = tau.multi_variety.forest_X_sp_kr)
...
variety_hat <- predict(b_variety, newdata = pred_sp)

variety_hat <- as.data.frame(variety_hat)

pred_variety_hat <- cbind(pred, variety_hat)

pred_variety_hat$sigma <- NULL
library(terra)

myras_variety <- rast(pred_variety_hat, type = "xyz")
plot(myras_variety)

library(raster)
myras2_variety <- raster(myras_variety)

library(sf)
India_aoi_sf_dis_sp <- as_Spatial(India_aoi_sf_dis)

myras2_variety <- mask(myras2_variety, India_aoi_sf_dis_sp)

plot(myras2_variety, main = "Yield gains early variety (1-10 Nov")

library(rasterVis)

levelplot(myras2_variety, layers = 1, margin = list(FUN = 'median'), contour=TRUE)

library(tmap)
myras2_variety_yield_gain=tm_shape(myras2_variety) +
  tm_raster(title = "SUPER 303 variety yield gain(t/ha)",style = "cont", palette = "viridis")+
  tm_legend(position = c("right", "top"),legend.title.size=1,legend.text.size=1)
myras2_variety_yield_gain

tmap_save(myras2_variety_yield_gain,"figures/myras2_variety_yield_gain.png", dpi=300,width=5.88,height = 5.16)
```


# GRF Simple maximum yield treatment assignment
...
# GRF Status quo to optimal shares: Transitions
...
ggsave("figures/transitionmatrixplot_irrig_cost.png", dpi=300,width=5.88,height = 4.16)
